    ...
    <div className="pb-20 pt-36">
        ...
        <div className = "flex justify-center relative my-4 z-10">
          <div className = 'max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center'>
            ...
            <TypingAnimation
              words={["Digital BA @ McKinsey & Company", "Tech Entrepreneur", "AI Product Innovator", "Business Strategist", "AI Engineer", "Product Manager", "Technology Consultant", "Software Engineer"]}
              duration={100}
              delay={500}
